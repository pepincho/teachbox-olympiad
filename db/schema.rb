...
ActiveRecord::Schema.define(:version => 20140219193344) do
  ...
  create_table "likes_answer_questions", :force => true do |t|
  ...
  create_table "likes_answers_questions", :force => true do |t|
    t.integer  "quick_answer_id"
    t.integer  "user_id"
    t.datetime "created_at",      :null => false
    t.datetime "updated_at",      :null => false
